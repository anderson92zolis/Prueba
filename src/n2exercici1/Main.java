...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Entrada.llegirByte("introdueix edat de la tortuga George, l'edat introduïda serà de tipus byte?");
		//Entrada.llegirInt("introdueix edat de la tortuga George, l'edat introduïda serà de tipus int?");
		//Entrada.llegirFloat("introdueix edat de la tortuga George, l'edat introduïda serà de tipus Float?");
